...
# pixel fudger
nuke.pluginAddPath('plugins/pixelfudger3/icons')
...
#misc gizmos
#toolbar.addMenu("Gizmos", icon="bu.png")
toolbar.addCommand("Gizmos/BeerLambertAttenuation/BeerLambertAttenuation", "nuke.createNode('BeerLambertAttenuation')")
toolbar.addCommand("Gizmos/BeerLambertAttenuation/DeepBeerLambertAttenuation", "nuke.createNode('DeepBeerLambertAttenuation')")
toolbar.addCommand("Gizmos/BU_bracketMerge","nuke.createNode('BU_bracketMerge')")
toolbar.addCommand("Gizmos/BU_greyMirrorBall","nuke.createNode('BU_greyMirrorBall')")
toolbar.addCommand("Gizmos/BU_morseToCurve","nuke.createNode('BU_morseToCurve')")
toolbar.addCommand("Gizmos/BU_outWrite","nuke.createNode('BU_outWrite')")
toolbar.addCommand("Gizmos/BU_previewWrite","nuke.createNode('BU_previewWrite')")
toolbar.addCommand("Gizmos/BU_stMapGen","nuke.createNode('BU_stMapGen')")
#toolbar.addCommand("Gizmos/Denoiser", "nuke.createNode('Denoiser')")
toolbar.addCommand("Gizmos/Expoglow", "nuke.createNode('expoglow')")
toolbar.addCommand("Gizmos/FrameFiller", "nuke.createNode('FrameFiller')", icon="FrameFiller.png")
toolbar.addCommand("Gizmos/ImagePlane", "nuke.createNode('ImagePlane')")
toolbar.addCommand("Gizmos/mmColorTarget", "nuke.createNode('mmColorTarget')", icon="mmColorTarget.png")
toolbar.addCommand("Gizmos/OpticalReflection", "nuke.createNode('OpticalReflection')")
toolbar.addCommand("Gizmos/SliceTool", "nuke.createNode('SliceTool')")
toolbar.addCommand("Gizmos/TransformReference", "nuke.createNode('TransformReference')")
toolbar.addCommand("Gizmos/Vector_FrameBlend", "nuke.createNode('Vector_FrameBlend')")
toolbar.addCommand("Gizmos/VectorTracker", "nuke.createNode('VectorTracker.gizmo')")